...
1. **`approval_lifecycle.expire_on_tool_match`**, a configured MCP tool name completes (PostToolUse), clearing the marker (agent-tasks task-boundary tools by default).
