...
// ran under that mode, and it would open a second, unconditional
// signing surface for the marker-signing key (not a path to mint an
// approval marker, which stays namespaced by markerId). See
// docs/decisions/2026-08-27-ug-auto-mode-approval.md's "Amendment:
