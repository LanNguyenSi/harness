...
describe("generateCodexConfig", () => {
  ...
  it("snake_cases known event names", () => {
    ...
    expect(content).toContain("[[hooks.session_start]]");
    expect(content).toContain("[[hooks.post_tool_use]]");
  });
  ...
  it("expands Claude-style tool names to Codex hook match aliases", () => {
    ...
    expect(content).toContain(
      'match = "Bash|shell|exec_command|functions.exec_command"',
    );
    expect(content).toContain(
      'match = "mcp__agent-tasks__pull_requests_create|mcp__agent-tasks__.pull_requests_create|mcp__agent_tasks__pull_requests_create|mcp__agent_tasks__.pull_requests_create"',
    );
  });
